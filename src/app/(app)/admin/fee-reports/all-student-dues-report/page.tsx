...
import { getAllStudentDuesReportDataAction } from './actions';
...
export default function AllStudentDuesReportPage() {
    ...
    const loadReportData = useCallback(async () => {
        ...
        const result = await getAllStudentDuesReportDataAction({
            adminUserId,
            filters: {
        ...
        setIsLoading(false);
    }, [toast, classFilter, searchTerm, classes.length]);
    ...
    const handleDownloadCsv = () => {
        ...
        link.setAttribute("download", `all_student_dues_report_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    return (
        <div className="flex flex-col gap-6">
            <PageHeader 
                title="All Student Dues Report"
                description="View all students with outstanding fee dues across all classes."
            ...
            />
             ...
             <Card>
                <CardHeader>
                    <CardTitle>Total Outstanding Dues Across School</CardTitle>
                </CardHeader>
                <CardContent>
