...
export default function YearWisePaidReportPage() {
    ...
    const loadReportData = useCallback(async () => {
        ...
        const result = await getYearWisePaidReportDataAction({
            adminUserId,
            filters: {
        ...
        setIsLoading(false);
    }, [toast, classFilter, yearFilter, paymentStatusFilter, searchTerm, classes.length]);
    ...
    const handleDownloadCsv = () => {
        ...
        const headers = ["Student Name", "Class", "Total Amount", "Paid Amount", "Due Amount", "Mode", "Last Payment Date"];
        const csvRows = [
            headers.join(','),
            ...reportData.map(d => {
